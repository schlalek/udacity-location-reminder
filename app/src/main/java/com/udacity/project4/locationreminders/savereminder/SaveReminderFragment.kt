...
class SaveReminderFragment : BaseFragment() {
    ...
    private fun checkDeviceLocationSettingsAndStartGeofence(item: ReminderDataItem) {
    ...
    private fun addGeofenceForReminder(item: ReminderDataItem) {
